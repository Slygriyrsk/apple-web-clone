...
function Model(props) {
  ...
  const texture = useTexture(props.item.img);
    ...
    }, [materials, props.item]); //callinf when we change the color prompt
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh
        ...
        scale={0.01}
      >
        <meshStandardMaterial roughness={1} map={texture} /> {/* added this to show some rough color on the iphones for more realistic */}
      </mesh>
      <mesh
        castShadow
        receiveShadow
